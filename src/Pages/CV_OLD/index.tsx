...
import {Description, H2, H3, Wrapper} from '../../styles'
...
const Cvs = () => {
    ...
    return (
        <Wrapper>
            ...
            <Description style={{display: dropped.includes('about') ? 'block': 'none'}}>
            ...
            <Description style={{display: dropped.includes('Objective') ? 'flex': 'none'}}>
            ...
            <Description style={{display: dropped.includes('Education') ? 'flex': 'none'}}>
                <ul>
            ...
            <Description style={{display: dropped.includes('Skills') ? 'block': 'none'}}>
                <H3>Programming</H3>
                <ul>
            ...
            <Description style={{display: dropped.includes('Employment history') ? 'block': 'none'}}>
                <ul>
                    <li>
